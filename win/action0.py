...
class ActionViews:
    ...
    def add_action(root, show_window, add_window, user, property, message):
        ...
        if show_window != False:
            show_window.destroy()
            ActionViews.show_window(root, user, False)
    ...
    def confirm_window(root, show_window, add_window, user, property, message):
        ...
        button = Button(confirm_action_window, text=button_text, font=user.large_font, bg=user.button_bg_colour, command=lambda: ActionViews.add_action(root, show_window, add_window, user, property, message))
    ...
    def add_window(root, show_window, user):
        ...
        button = Button(add_action_window, text=button_text, font=user.large_font, bg=user.button_bg_colour, command=lambda: ActionViews.confirm_window(root, show_window, add_action_window, user, entry_property.get(), entry_message.get()))
    ...
    def show_window(root, user, number):     # number is for where a see_window is being auto-launched, otherwise False
        ...
        add_button = Button(bottom_frame, text='Add Action', font=user.large_font, bg=user.button_bg_colour, command=lambda: ActionViews.add_window(root, show_actions_window, user))
